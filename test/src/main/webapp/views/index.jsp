        ...
        <div class="collapse navbar-collapse" id="collapsibleNavbar">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item d-sm-block d-md-none ljoin">
              <a href="member/login.jsp"> <img src="./img/icon-member.png">&nbsp;&nbsp;Login</a>&nbsp;
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-content">
                <a href="<c:url value="/community/board"/> ">공지사항</a>
                <a href="#">홍보자료</a>
                <a href="#">채용안내</a>
              </div>
            </li>
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-content">
                <a href="<c:url value="/customer/one2one"/> ">1:1문의</a>
                <a href="<c:url value="/customer/qnaboard"/> ">묻고답하기</a>
                <a href="#">FAQ</a>
              </div>
            </li>
          </ul>
