...
<script>
    let geo1 = {
        ...
        display:function(){
            ...
            var iwContent =
                '<div style="padding:5px;">Hello World!<br><img style="width:200px;" src="<c:url value="/img/stdimg.jpg"/>"></div>'; // 인포윈도우에 표출될 내용으로 HTML 문자열이나 document element가 가능합니다
